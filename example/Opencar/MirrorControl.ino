...
struct can_frame frames[15];  // Mảng chứa 15 frames

void setup() {
  Serial.begin(115200);
  delay(1000);
  
  Serial.println("=== Smart Car Unlock System ===");
  ...
  // Khởi tạo tất cả 15 frames
  Serial.println("Configuring 15 CAN frames...");
  
  // Frame 1: 0x003
  frames[0].can_id  = 0x003;
  frames[0].can_dlc = 8;
  frames[0].data[0] = 0x00; frames[0].data[1] = 0x00; frames[0].data[2] = 0x12; frames[0].data[3] = 0x00;
  ...
  frames[4].can_dlc = 8;
  frames[4].data[0] = 0x01; frames[4].data[1] = 0x00; frames[4].data[2] = 0x00; frames[4].data[3] = 0x06;
  frames[4].data[4] = 0x00; frames[4].data[5] = 0x20; frames[4].data[6] = 0x00; frames[4].data[7] = 0x00;
  
  // Frame 6: 0x104
  frames[5].can_id  = 0x104;
  frames[5].can_dlc = 8;
  frames[5].data[0] = 0x00; frames[5].data[1] = 0x14; frames[5].data[2] = 0x01; frames[5].data[3] = 0x03;
  frames[5].data[4] = 0x3C; frames[5].data[5] = 0x81; frames[5].data[6] = 0x00; frames[5].data[7] = 0x00;
  
  // Frame 7: 0x003
  frames[6].can_id  = 0x003;
  frames[6].can_dlc = 8;
  frames[6].data[0] = 0x00; frames[6].data[1] = 0x00; frames[6].data[2] = 0x00; frames[6].data[3] = 0x00;
  frames[6].data[4] = 0x00; frames[6].data[5] = 0x00; frames[6].data[6] = 0x00; frames[6].data[7] = 0x00;
  
  // Frame 8: 0x100
  frames[7].can_id  = 0x100;
  frames[7].can_dlc = 8;
  frames[7].data[0] = 0x07; frames[7].data[1] = 0x00; frames[7].data[2] = 0x00; frames[7].data[3] = 0x00;
  ...
  frames[9].can_dlc = 8;
  frames[9].data[0] = 0x00; frames[9].data[1] = 0x04; frames[9].data[2] = 0x01; frames[9].data[3] = 0x00;
  ...
  // Frame 12: 0x100
  frames[11].can_id  = 0x100;
  frames[11].can_dlc = 8;
  frames[11].data[0] = 0x07; frames[11].data[1] = 0x00; frames[11].data[2] = 0x00; frames[11].data[3] = 0x00;
  frames[11].data[4] = 0x00; frames[11].data[5] = 0x20; frames[11].data[6] = 0x00; frames[11].data[7] = 0x00;
  
  // Frame 13: 0x104
  frames[12].can_id  = 0x104;
  frames[12].can_dlc = 8;
  frames[12].data[0] = 0x05; frames[12].data[1] = 0x0E; frames[12].data[2] = 0x01; frames[12].data[3] = 0x00;
  frames[12].data[4] = 0x3C; frames[12].data[5] = 0x81; frames[12].data[6] = 0x00; frames[12].data[7] = 0x00;
  
  // Frame 14: 0x100
  frames[13].can_id  = 0x100;
  frames[13].can_dlc = 8;
  frames[13].data[0] = 0x21; frames[13].data[1] = 0x00; frames[13].data[2] = 0x00; frames[13].data[3] = 0x00;
  frames[13].data[4] = 0x00; frames[13].data[5] = 0x20; frames[13].data[6] = 0x00; frames[13].data[7] = 0x00;

  // Frame 15: 0x104
  frames[14].can_id  = 0x104;
  frames[14].can_dlc = 8;
  frames[14].data[0] = 0x05; frames[14].data[1] = 0x0E; frames[14].data[2] = 0x01; frames[14].data[3] = 0x00;
  ...
  Serial.println("\n=== READY TO UNLOCK ===");
  Serial.println("Send 'O' or 'o' to OPEN/UNLOCK the car");
...
void unlockCar() {
  ...
  for (int i = 0; i < 15; i++) {
    ...
    delay(20);  // Delay giữa các frames
  }
  
  Serial.println("===================================");
  if (failed == 0) {
    Serial.println("✓ Car UNLOCKED successfully!");
  } else {
...
void loop() {
  if (Serial.available()) {
    ...
    if (cmd == 'O' || cmd == 'o') {
      ...
      Serial.print(cmd);
      Serial.println("' - Send 'O' to unlock");
    }
  }
